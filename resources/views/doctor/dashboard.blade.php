...
<head>
    ...
    <style>
        ...
        .navbar { background: linear-gradient(135deg, #1a6b3c, #2E7D32); }
        ...
        .welcome-card { background: linear-gradient(135deg, #1a6b3c, #2E7D32); border-radius: 15px; }
    </style>
</head>
<body>
...
<div class="container mt-4">
    ...
    <div class="welcome-card text-white p-4 mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h2 class="mb-0 fw-bold">Bienvenue, Dr. {{ auth()->user()->name }} !</h2>
                <p class="mb-0 opacity-75">Tableau de bord Médecin</p>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="card card-stat p-3 text-center">
                ...
                <h5 class="mt-2 text-muted">RDV Aujourd'hui</h5>
        ...
        <div class="col-md-4">
            <div class="card card-stat p-3 text-center">
                <div style="font-size: 2.5rem;">👥</div>
                <h5 class="mt-2 text-muted">Mes Patients</h5>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <button class="btn btn-primary w-100">
                        <i class="bi bi-file-medical"></i> Nouvelle Consultation
                    </button>
                </div>
                <div class="col-md-4">
