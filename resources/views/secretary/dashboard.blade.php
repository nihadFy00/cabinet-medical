...
<head>
    ...
    <style>
        ...
        .navbar { background: linear-gradient(135deg, #6A1E82, #8E24AA); }
        ...
        .welcome-card { background: linear-gradient(135deg, #6A1E82, #8E24AA); border-radius: 15px; }
    </style>
</head>
<body>
    ...
    <div class="welcome-card text-white p-4 mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="mb-0 opacity-75">Tableau de bord Secrétaire</p>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="card card-stat p-3 text-center">
                ...
                <h5 class="mt-2 text-muted">RDV du Jour</h5>
                <h2 class="fw-bold text-purple" style="color:#8E24AA">--</h2>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-stat p-3 text-center">
                <div style="font-size: 2.5rem;">👥</div>
                <h5 class="mt-2 text-muted">Total Patients</h5>
        ...
        <div class="col-md-4">
            <div class="card card-stat p-3 text-center">
                <div style="font-size: 2.5rem;">⏳</div>
                <h5 class="mt-2 text-muted">RDV En Attente</h5>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <a href="{{ route('rendezvous.create') }}" class="btn w-100 text-white" style="background:#8E24AA">
                        <i class="bi bi-calendar-plus"></i> Nouveau RDV
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('patients.index') }}" class="btn btn-info w-100 text-white">
                        <i class="bi bi-search"></i> Rechercher Patient
                    </a>
                </div>
            </div>
        </div>
